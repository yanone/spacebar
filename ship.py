...
['Validate notarization', 'spctl -a -vvv -t install "Space Bar.glyphsReporter"', None, ''],
['Staple notarization to plugin', 'xcrun stapler staple "Space Bar.glyphsReporter"', None, ''],
['Validate stapling', 'stapler validate "Space Bar.glyphsReporter"', None, ''],

['Create shipping folder', 'mkdir ship', None, ''],
['Copy files', 'cp -R "Space Bar.glyphsReporter" ship', None, ''],
['Copy files', 'cp Install.txt ship', None, ''],
['Copy files', 'cp "Read Me.txt" ship', None, ''],

['ZIP it again', 'ditto -c -k --rsrc ship "Space Bar.glyphsReporter.ship.zip"', None, ''],
